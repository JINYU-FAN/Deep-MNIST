...
models = ['FCN_784-100-100-10', 'resnet101', 'alexnet-48-128-M-192-M-192-128-M',
 'resnet34', 'resnet50', 'FCN_784-500-500-10', 'resnet18',
  'alexnet-32-96-M-192-M-128-128-M', 'alexnet-24-64-M-96-M-96-64-M',
   'alexnet-64-192-M-384-M-256-256-M', 'FCN_784-500-10', 'FCN_784-100-10']
...
for model in models:
    ...
    for dataset in datasets:
        results = []
        for i in range(10):
            results.append(test('cuda:6', f'FMResults/{model}', f'FashionMNIST/{dataset}', i+1))
